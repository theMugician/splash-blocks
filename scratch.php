...
namespace Splash_Blocks\Fields;
...
class File extends Input {
    ...
    static public function html_file( $meta ) {
        ...
        $i18n_delete = apply_filters('spf_file_delete_string', _x('Delete', 'file upload', 'splash-blocks'));
        $i18n_edit = apply_filters('spf_file_edit_string', _x('Edit', 'file upload', 'splash-blocks'));
